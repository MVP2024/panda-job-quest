...
def test_vacancy_init_default() -> None:
...
def test_vacancy_init_with_minimal_values() -> None:
    """Тест инициализации вакансии с минимальными обязательными значениями"""
    vacancy = Vacancy(title="Python Developer", url="https://example.com")
...
def test_vacancy_init_with_full_values() -> None:
...
@pytest.mark.parametrize(
    ...
    [(None, 0.0), (50000, 50000.0), ({"from": 50000, "to": 100000}, 75000.0), ({"from": 0, "to": 0}, 0.0)],
)
def test_vacancy_salary_handling(
    base_vacancy_data: Dict[str, Any], salary_input: Union[None, int, Dict[str, int]], expected: float
) -> None:
...
def test_vacancy_employer_handling(
    base_vacancy_data: Dict[str, Any], employer_input: Optional[str], expected: str
) -> None:
...
def test_vacancy_invalid_title(base_vacancy_data: Dict[str, Any], invalid_title: Optional[str]) -> None:
...
def test_vacancy_invalid_url(base_vacancy_data: Dict[str, Any], invalid_url: Optional[str]) -> None:
...
def test_vacancy_description_handling(
    base_vacancy_data: Dict[str, Any], description_input: Optional[str], expected: str
) -> None:
...
def test_vacancy_to_dict(base_vacancy_data: Dict[str, Any]) -> None:
    """Тест преобразования вакансии в словарь"""
    base_vacancy_data.update({"salary": 50000.0, "description": "Тестовое описание", "employer": "Google"})
    vacancy = Vacancy(**base_vacancy_data)
...
def test_vacancy_comparison(base_vacancy_data: Dict[str, Any]) -> None:
    """Тест сравнения вакансий по зарплате"""
    base_vacancy_data["salary"] = 50000.0
    vacancy1 = Vacancy(**base_vacancy_data)

    base_vacancy_data["salary"] = 60000.0
...
def test_vacancy_repr(base_vacancy_data: Dict[str, Any]) -> None:
...
def test_vacancy_format_salary(base_vacancy_data: Dict[str, Any]) -> None:
...
def test_vacancy_format_salary_zero(base_vacancy_data: Dict[str, Any]) -> None:
    """Тест форматирования нулевой зарплаты"""
    base_vacancy_data["salary"] = 0.0
    vacancy = Vacancy(**base_vacancy_data)
