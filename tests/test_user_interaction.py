...
def test_display_vacancies_empty(capsys):
...
def test_display_vacancies_with_data(capsys, sample_vacancies_user_interaction):
...
class TestMainMenu:
    def test_main_menu_flow(self, mock_input_sequence, mock_api_data):
        """
        ...
        with (
            ...
            patch('src.user_interaction.HeadHunterAPI.get_vacancies', return_value=mock_api_data) as mock_get_vacancies,
    ...
    def test_main_menu_invalid_choice(self, mock_input_sequence):
        """
    ...
    def test_main_menu_top_vacancies(self, mock_input_sequence):
        """
        ...
        with (
            patch('builtins.input', side_effect=input_sequence),
            patch('src.user_interaction.HeadHunterAPI'),
            patch('src.user_interaction.JSONStorage.get_vacancies', return_value=[
                {
    ...
    def test_main_menu_search_by_keyword(self, mock_input_sequence):
        """
        ...
        with (
            patch('builtins.input', side_effect=input_sequence),
            patch('src.user_interaction.HeadHunterAPI'),
            patch('src.user_interaction.JSONStorage.get_vacancies', side_effect=[
    ...
    def test_main_menu_error_handling(self, mock_input_sequence):
        """
